...
class HomeController extends Controller
{
    public function home()
    {
        ...
        return view('frontend.content.content', ['active' => 'home', 'title' => 'Home', 'latestProducts' => $latestProducts, 'heading' => $heading, 'description' => $description, 'latestSubcategories' => $latestSubcategories]);
    }
