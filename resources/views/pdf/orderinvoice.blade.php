...
<head>
    ...
    <style>
        ...
        .invoice-container {
            ...
            margin: 20px auto; /* Center the invoice */
        ...
        .table tbody tr:nth-child(even) {
            background-color: #f2f2f2;  /* Adds a different color to alternate rows */
        }
    </style>
</head>
<body>
...
<div class="container invoice-container">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p><strong>Address:</strong> {{ $order->address ?? 'No address' }}, {{ $order->city ?? 'No city'  }}, {{ $order->zip_code ?? 'No zip Code' }}</p>
            ...
            @foreach ($orderItems as $index => $item)
                <tr>
                    ...
                    <td class="align-middle text-center">
                        <img src="{{ public_path($item->product->image) }}" class="product-image" alt="Product Image">
                    </td>
                    <td class="align-middle text-center">{{ $item->product->name }}</td>
                    <td class="align-middle text-center">£{{ number_format($item->product->price, 2) }}</td>
